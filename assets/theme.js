...
PaloAlto.QuickBuy = {
  init: function(container) {
    console.log('in quickbuy function');
...
// EWG Custom Code
	var faq = $('[data-type="bldg-faq"]');
	
	if(faq.length) {
	    
		$('body').on('click', '[data-type="bldg-faqItem"]', function() {
			$(this).parents('[data-type="bldg-faq"]').toggleClass('active');
			$(this).parents('[data-type="bldg-faq"]').find('.bldg-faqElement-answer').slideToggle(300, function() { 
	...
	var tabs = $('[data-type="bldg-tabs"]');
	
	if(tabs.length) {
		
		$('body').on('click', '[data-type="bldg-tabTrigger"]', function() {
			var tabTrigger = $(this);
			var tabs_element = tabTrigger.parents('[data-type="bldg-tabs"]');
			var target = tabTrigger.data('target');
			
			tabs_element.find('[data-type="bldg-tabTrigger"]').removeClass('active');
			tabs_element.find('[data-type="bldg-tab"]').removeClass('active');
			
			tabs_element.find('[data-id="'+target+'"]').addClass('active');
